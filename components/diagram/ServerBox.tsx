...
export default async function ServerBox({ children, hint }: ServerBoxProps ) {
    ...
    return (
        <div className={"bg-orange-600 p-5 border-2 border-black"}>
            ...
            {
                hint &&
                <div className={"text-lg"}>This user's info was loaded (on the server) before it's parent client component was rendered in.</div> &&
                <div className={"text-lg"}>This is why as soon as the parent client component is rendered in, the user info is already avaiable</div>
            }
